...
public class Fireball extends Component {
	...
	private static final int COLOR = Game.instance.getResources().getInteger(R.integer.fireballcolor);
	...
	public void update() {
		...
		if (Random.Float() < Game.elapsed) {
			...
			spark.reset( x, y, ColorMath.random( COLOR, Game.instance.getResources().getInteger(R.integer.fireball) ), 2, Random.Float( 0.5f, 1.0f ) );
			spark.speed.set(
				Random.Float( -40, +40 ),
				Random.Float( -60, +20 ) );
			spark.acc.set( 0, +80 );
