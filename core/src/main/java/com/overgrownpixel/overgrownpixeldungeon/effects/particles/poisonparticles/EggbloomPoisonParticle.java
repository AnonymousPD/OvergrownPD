...
public class EggbloomPoisonParticle extends PixelParticle {

    public static final Factory FACTORY = new Factory() {
        @Override
        public void emit(Emitter emitter, int index, float x, float y ) {
            ((EggbloomPoisonParticle)emitter.recycle( EggbloomPoisonParticle.class )).reset( x, y );
        }
        @Override
    ...
    public EggbloomPoisonParticle() {
        size(2.0f);
        color(Game.instance.getResources().getInteger(R.integer.eggbloompoisonparticle));
