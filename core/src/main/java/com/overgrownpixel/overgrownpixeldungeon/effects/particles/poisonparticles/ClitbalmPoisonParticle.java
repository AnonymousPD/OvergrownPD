...
public class ClitbalmPoisonParticle extends PixelParticle {

    public static final Factory FACTORY = new Factory() {
        @Override
        public void emit(Emitter emitter, int index, float x, float y ) {
            ((ClitbalmPoisonParticle)emitter.recycle( ClitbalmPoisonParticle.class )).reset( x, y );
        }
        @Override
    ...
    public ClitbalmPoisonParticle() {
        size(2.0f);
        color(Game.instance.getResources().getInteger(R.integer.clitbalmpoisonparticle));
