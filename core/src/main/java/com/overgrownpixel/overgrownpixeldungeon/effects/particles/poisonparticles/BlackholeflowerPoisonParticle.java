...
public class BlackholeflowerPoisonParticle extends PixelParticle {

    public static final Factory FACTORY = new Factory() {
        @Override
        public void emit(Emitter emitter, int index, float x, float y ) {
            ((BlackholeflowerPoisonParticle)emitter.recycle( BlackholeflowerPoisonParticle.class )).reset( x, y );
        }
        @Override
