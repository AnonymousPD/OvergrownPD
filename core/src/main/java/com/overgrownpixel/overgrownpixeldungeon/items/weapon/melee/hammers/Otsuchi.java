...
public class Otsuchi extends MeleeWeapon {

	{
		image = ItemSpriteSheet.OTSUCHI;
	...
	public int max(int lvl) {
        return  Math.round(3f*(tier+1)) +       //6 base, down from 20
                lvl*Math.round(2f*(tier));      //+2 per level, down from +4
	}
