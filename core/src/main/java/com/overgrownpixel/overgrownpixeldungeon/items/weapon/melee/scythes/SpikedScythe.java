...
package com.overgrownpixel.overgrownpixeldungeon.items.weapon.melee.scythes;
...
public class SpikedScythe extends MeleeWeapon {

	{
		image = ItemSpriteSheet.SPIKED_SCYTHE;

		tier = 5;
        ACC = 0.8f; //-20% accuracy
        RCH = 3;
	}
