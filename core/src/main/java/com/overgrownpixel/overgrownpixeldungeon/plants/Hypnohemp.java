...
public class Hypnohemp extends Plant {
    ...
    public void spiceEffect(Char ch) {
        ch.sprite.burst(new HypnohempPoisonParticle().getColor(), 10);
        int newpos;
        int trys = 8;
        do{
        ...
        GameScene.add(Blob.seed(newpos, 10, CloudOfCorruption.class));
    }
    ...
    public static class Seed extends Plant.Seed{
        ...
        public Emitter.Factory getPixelParticle() {
            return HypnohempPoisonParticle.FACTORY;
        }

        @Override
        public PixelParticle poisonEmitterClass() {
            return new HypnohempPoisonParticle();
        }
