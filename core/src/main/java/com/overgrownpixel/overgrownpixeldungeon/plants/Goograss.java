...
import com.overgrownpixel.overgrownpixeldungeon.actors.blobs.OozeGas;
import com.overgrownpixel.overgrownpixeldungeon.effects.particles.poisonparticles.GoograssPoisonParticle;
...
public class Goograss extends Plant {
    ...
    public void spiceEffect(Char ch) {
        ...
        GameScene.add(Blob.seed(newpos, 10, OozeGas.class));
    }
