...
public class OGPDSettings extends GameSettings {
	...
	public static void fullscreen( boolean value ) {
		...
		OvergrownPixelDungeon.instance.runOnUiThread(new Runnable() {
			@Override
			public void run() {
				OvergrownPixelDungeon.updateSystemUI();
			}
		} );
	}
	...
	public static void landscape( boolean value ){
		...
		((OvergrownPixelDungeon) OvergrownPixelDungeon.instance).updateDisplaySize();
	}
	...
	public static String toolbarMode() {
		return getString(KEY_BARMODE, !OGPDSettings.landscape() ? "SPLIT" : "GROUP");
	}
	...
	public static boolean systemFont(){
		return getBoolean(KEY_SYSTEMFONT, /**(language() == Languages.KOREAN || language() == Languages.CHINESE)**/false);
	}
