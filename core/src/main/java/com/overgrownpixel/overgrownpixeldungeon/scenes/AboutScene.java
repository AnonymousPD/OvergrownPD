...
public class AboutScene extends PixelScene {
    ...
    private static final String LNK_SHPX = "Discord.OvergrownPixelDungeon.com";
    ...
    public void create() {
        ...
        final float colWidth = Camera.main.width / (OGPDSettings.landscape() ? 2 : 1);
        final float colTop = (Camera.main.height / 2) - (OGPDSettings.landscape() ? 30 : 90);
        final float wataOffset = OGPDSettings.landscape() ? colWidth : 0;
        ...
        shpxlink.hardlight( Window.OGPX_COLOR);
        add( shpxlink );
        ...
        TouchArea shpxhotArea = new TouchArea( shpxlink.left(), shpxlink.top(), shpxlink.width(), shpxlink.height() ) {
            ...
            protected void onClick( Touch touch ) {
                DeviceCompat.openURI( "https://discord.gg/H4zGVv6");
            }
        };
        add( shpxhotArea );
