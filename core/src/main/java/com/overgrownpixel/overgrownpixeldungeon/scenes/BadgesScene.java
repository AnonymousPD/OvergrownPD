...
import com.overgrownpixel.overgrownpixeldungeon.windows.WndBadge;
...
public class BadgesScene extends PixelScene {
	...
	public void create() {
		...
		int nCols = OGPDSettings.landscape() ? 7 : 4;
		if (badges.size() + blankBadges > 32 && !OGPDSettings.landscape())	nCols++;
