...
import com.overgrownpixel.overgrownpixeldungeon.ui.QuickRecipe;
...
public class WndJournal extends WndTabbed {
	...
	public WndJournal(){
		...
		int width = OGPDSettings.landscape() ? WIDTH_L : WIDTH_P;
		int height = OGPDSettings.landscape() ? HEIGHT_L : HEIGHT_P;
