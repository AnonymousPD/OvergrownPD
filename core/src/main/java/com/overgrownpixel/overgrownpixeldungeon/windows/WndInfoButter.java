...
public class WndInfoButter extends WndTitledMessage {

	public WndInfoButter(Butter butter ) {
		
		super(TerrainFeaturesTilemap.tile( butter.pos, Dungeon.level.map[butter.pos]),
				butter.name, butter.desc);
