...
public class CococlamSprite extends MobSprite {

	public CococlamSprite() {
		super();
		
		texture( Assets.COCOCLAM );
	...
	@Override
	public int blood() {
		return Game.instance.getResources().getInteger(R.integer.cocostuftpoisonparticle);
	}
	
	@Override
	public void onComplete( Animation anim ) {
		if (anim == die) {
			emitter().burst( CocostuftPoisonParticle.FACTORY, 4 );
		}
