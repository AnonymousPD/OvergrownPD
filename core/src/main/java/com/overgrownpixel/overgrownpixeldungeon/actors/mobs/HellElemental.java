...
import com.overgrownpixel.overgrownpixeldungeon.sprites.mobs.HellElementalSprite;
import com.watabou.utils.Random;

public class HellElemental extends Mob {

	{
		spriteClass = HellElementalSprite.class;
	...
	public int attackProc( Char enemy, int damage ) {
		...
		if (Random.Int( 2 ) == 0) {
			Buff.affect( enemy, HellBurning.class ).reignite( enemy );
		}
