...
import com.overgrownpixel.overgrownpixeldungeon.sprites.mobs.ForceShamanSprite;

public class WaterShaman extends Shaman {
	
	{
		spriteClass = ForceShamanSprite.class;
	}
