...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			...
			"com.overgrownpixel.overgrownpixeldungeon.messages.scenes.scenes",
			"com.overgrownpixel.overgrownpixeldungeon.messages.ui.ui",
			"com.overgrownpixel.overgrownpixeldungeon.messages.windows.windows",
			"com.overgrownpixel.overgrownpixeldungeon.messages.misc.misc"
	};

	static{
		setup(OGPDSettings.language());
	}
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.overgrownpixel.overgrownpixeldungeon.", "");
			key += "." + k;
		} else
			key = k;
