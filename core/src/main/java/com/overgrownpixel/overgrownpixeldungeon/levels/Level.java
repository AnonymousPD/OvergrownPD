...
import com.overgrownpixel.overgrownpixeldungeon.actors.mobs.Bestiary;
import com.overgrownpixel.overgrownpixeldungeon.actors.mobs.Mob;
import com.overgrownpixel.overgrownpixeldungeon.effects.particles.FlowParticle;
...
public abstract class Level implements Bundlable {
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		if (version < OvergrownPixelDungeon.v0_6_5c){
        ...
        collection = bundle.getCollection( FLORA );
        for (Bundlable p : collection) {
    ...
    public WallFlora setflora(WallFlora floras, int pos ){
        WallFlora existingPlate = flora.get(pos);
        if (existingPlate != null){
            flora.remove( pos );
        }
        floras.set( pos );
        flora.put( pos, floras );
        GameScene.updateMap( pos );
        return floras;
    }
