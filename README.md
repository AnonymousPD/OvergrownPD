...
Overgrown Pixel Dungeon on Google Play:
https://play.google.com/store/apps/details?id=com.overgrownpixel.overgrownpixeldungeon

Source code of original Pixel Dungeon (adapted to use newer build tools):
https://github.com/00-Evan/pixel-dungeon-gradle

# Compiling Overgrown Pixel Dungeon

To compile Overgrown Pixel Dungeon you will need:
...
- (optional) an android phone to test your build of Overgrown Pixel Dungeon
...
It is optional, but strongly recommended, to use version control to manage your copy of the Overgrown Pixel Dungeon codebase. Version control is software which helps you manage changes to code. To use version control you will need to download and install [Git](https://git-scm.com/downloads). You are welcome to use a separate graphical git client or git CLI if you prefer, but this guide will use Android Studio's built-in git tools.
